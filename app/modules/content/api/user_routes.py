...
async def _get_optional_current_user(
	...
	if credentials is None:
		return None
	return await require_permission(audience="user")(await get_current_user(credentials))
...
async def delete_post(
	...
	await service.delete_post(post_id, current_user["sub"], can_delete_any=False)
